...
public class BaselineFillService {
    ...
    public void tickOnce() {
        ...
        log.info("tickOnce handle={}, nextPage={}", handle, nextPage);
        ...
        log.info("tickOnce fetched page isNull={}", page == null);
